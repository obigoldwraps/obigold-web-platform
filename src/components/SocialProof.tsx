...
export default function SocialProof() {
  ...
  return (
    /* 1. BACKGROUND UPDATE: Changed gradient from #1C1C1C (Grey) to #000000 (Black) */
    <section id="social" className="relative py-24 md:py-32 px-4 md:px-8 bg-gradient-to-b from-[#0A0A0A] to-black overflow-hidden">
            ...
            <div className="group">
              ...
              <div className="text-left">
                ...
                <a href={`https://www.instagram.com/${InstagramHandle}`} target="_blank" rel="noopener noreferrer" 
                   className="group relative w-full md:w-auto inline-flex items-center justify-center gap-3 bg-obigold-gold-vibrant text-black px-8 py-4 rounded-2xl font-black text-lg md:text-xl overflow-hidden transition-all duration-500 hover:scale-105 hover:shadow-[0_0_40px_rgba(255,215,0,0.4)]"
                >
