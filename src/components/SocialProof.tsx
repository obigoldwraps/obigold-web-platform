...
export default function SocialProof() {
  // 1. Properly load the widget script
  useEffect(() => {
    ...
    return () => {
      // Cleanup to prevent duplicate widgets if the component re-renders
          ...
          >
            <div className="group">
              ...
              <div className="text-left">
                <h3 className="text-3xl font-black mb-6 text-obigold-gold-vibrant uppercase tracking-tight">
                  Follow the Journey
                </h3>
